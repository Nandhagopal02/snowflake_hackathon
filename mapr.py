...
india_tourism_info = {
    ...
    "Tamil Nadu": {
        "Top 10 Must-Visit Places": [
            {"name": "Chennai (Marina Beach)", "image_url": r"Images\tamil_nadu\marina-beach-chennai.jpg"},
            {"name": "Madurai (Meenakshi Temple)", "image_url": r"Images\tamil_nadu\Meenakshi.jpg"},
            {"name": "Vellore (Golden Temple)", "image_url": r"Images\tamil_nadu\vellore_t.jpg"},
            {"name": "Thanjavur (Brihadeeswarar Temple)", "image_url": r"Images\tamil_nadu\thanjavur.jpg"},
            {"name": "Tiruchirappalli", "image_url": r"Images\tamil_nadu\Tiruchirappalli.jpg"},
            {"name": "Rameswaram", "image_url": r"Images\tamil_nadu\pambann.jpg"},
            {"name": "Mahabalipuram", "image_url": r"Images\tamil_nadu\Mahabalipuram.jpg"},
            {"name": "Coimbatore", "image_url": r"Images\tamil_nadu\Coimbatore.jpg"},
            {"name": "Kodaikanal", "image_url": r"Images\tamil_nadu\kodaikanl.jpg"},
        ],
        "Best Season to Visit": "October to March (Winter and early Spring)"
    },
        ...
        if state_info:
            ...
            for i, place in enumerate(state_info["Top 10 Must-Visit Places"]):
                with cols[i % 3]:  # Cycle through columns
                    ...
                    img = Image.open(place['image_url'])
                    st.image(img, caption=place['name'], width=500)  # Set fixed width for images
        else:
